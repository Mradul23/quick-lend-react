...
export default function LandingPageComponent() {
	...
	return (
		<>
			<motion.div
				className="flex flex-col items-start pl-4 md:items-center"
			...
			>
				...
				<motion.svg
					...
					className="landing-page-football fill-fuchsia-900 md:fill-fuchsia-300 pointer-events-none"
				>
					<g>
				...
				<motion.svg
					className="landing-page-charger fill-fuchsia-900  md:fill-fuchsia-300 pointer-events-none"
